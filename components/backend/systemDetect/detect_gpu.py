"""
detect_gpu.py — Detect discrete GPU manufacturer, name, VRAM, and driver info.
...
Output (stdout, KEY=VALUE):
    ...
    GPU_NAME          — e.g. "NVIDIA GeForce RTX 4070"
    GPU_VRAM_MB       — e.g. "12288"  (omitted if unknown)
...
Exit 0 always; 'none' manufacturer means no discrete GPU found.
